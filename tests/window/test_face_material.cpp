...
// ---------------------------------------------------------------------------
static constexpr device::ShaderTag TEST_SHADER_TAG{"test_shader", "test.slang",
                                                   "vertMain", "fragMain"};
static constexpr window::MaterialTag TEST_MATERIAL_TAG{"test_material",
                                                       &TEST_SHADER_TAG};
static constexpr window::ObjectTag TEST_OBJ_TAG{"test_obj", &TEST_MATERIAL_TAG};
...
void test_object3d_face_material() {
  ...
  mat.textureId = 42;
  (void)mat.addEffect(device::FaceEffect{device::EffectType::eGradient, 0.5f, 0.0f});
...
void test_object2d_face_material() {
  ...
  device::FaceMaterial mat;
  (void)mat.addEffect(device::FaceEffect{device::EffectType::eWave, 0.05f, 4.0f});
...
void test_face_material_index_validation() {
  ...
  device::FaceMaterial mat;
  (void)mat.addEffect(device::FaceEffect{device::EffectType::eDrawing});
