...
int main(int argc, char *argv[]) {
  ...
  if (win1 && win1->hasRenderer() && material1->isInitialized()) {
    ...
    if (object1->initialize(vMan.getPrimaryAllocator(),
                            dMan.getPrimaryDevice(), *material1,
  ...
  if (win2 && win2->hasRenderer() && material2->isInitialized()) {
    ...
    if (object2->initialize(vMan.getPrimaryAllocator(),
                            dMan.getPrimaryDevice(), *material2,
