...
static constexpr window::ObjectTag TRIANGLE_2D_OBJ_TAG{"triangle_obj_2d",
                                                        &TRIANGLE_2D_MATERIAL_TAG};
static constexpr window::ObjectTag TRIANGLE_3D_OBJ_TAG{"triangle_obj_3d",
                                                        &TRIANGLE_3D_MATERIAL_TAG};
// Scene tags
