...
// Manages creation and lifecycle of objects, materials, and textures for a scene
class Scene {
protected:
  ...
  Object *create_multi_material_cube_3d(
  ...
  Object *create_multi_material_quad_2d(
  ...
  void create_basic_material(MaterialId materialId, bool is2D, bool is3DTextured = false);
