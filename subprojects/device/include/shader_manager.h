...
public:
     ...
     */
    std::future<ShaderCompileResult> compileAsync(const ShaderCompileRequest& request);
     ...
     */
    std::vector<ShaderCompileResult> compileBatch(const std::vector<ShaderCompileRequest>& requests);
