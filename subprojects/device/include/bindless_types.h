 ...
 * Used by Object::draw() to push time and objectId to shaders.
 * Wave displacement is handled per-face in the geometry shader
 * using per-face FaceData params and SV_PrimitiveID.
 */
